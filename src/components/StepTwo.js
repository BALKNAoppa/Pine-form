            ...
            <div className="w-[480px] h-[655px] rounded-lg p-8 bg-white flex flex-col justify-between">
                <div className="w-[416px] h-[385px]">
                    <div className="w-[416px] h-[129px] flex flex-col justify-between">
                        <PineconeLogo />
                        <p className="w-[416px] h-[31px] font-inter text-[26px] font-semibold leading-[31.47px] tracking[-0.03em] decoration-skip-[ink]"> Step 2 😎</p>
                ...
                <div className="flex justify-between">
                    ...
                    <button className="w-[280px] h-[44px] bg-black  text-white rounded-lg " onClick={handleNextStep} > Continue 2/3 <span>&gt;</span></button>
                </div>
            </div>
        </div>
    )
